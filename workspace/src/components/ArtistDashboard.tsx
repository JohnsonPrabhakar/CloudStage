        ...
        <Card className="bg-green-950/50 border-green-500/50">
          <CardHeader>
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <Crown className="h-8 w-8 text-green-500 shrink-0" />
              <div>
                <CardTitle className="text-green-400">You are a Premium Artist!</CardTitle>
                <CardDescription>
                  You have access to priority listing, free boosts, and advanced analytics.
                </CardDescription>
              </div>
            </div>
          </CardHeader>
